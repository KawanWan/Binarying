...
public class UniverseController {
    ...
    @PostMapping("")
    void create(@Valid @RequestBody Universe universe) throws InvalidObjectException{
        if (findById(universe.id()) != null) {
            throw new InvalidObjectException("This object already exists!");
        }
