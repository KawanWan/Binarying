...
function load() {
    ...
    fetch(`https://binarying-backend-back.azuremicroservices.io/api/phase/arrayMap/${worldId}`)
...
function loadPhases(arrayMap) {
    fetch(`https://binarying-backend-back.azuremicroservices.io/api/phase?worldId=${worldId}`)
            .then(response => response.json())
